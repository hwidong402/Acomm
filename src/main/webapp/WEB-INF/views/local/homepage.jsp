...
<head>
<meta charset="UTF-8">
<title>${apt.apt_name}에 오신것을 환영합니다!</title>
...
<div>
    <div id="header">
        <img id="apt_img_logo" src= "resources/img/${member.apt_code}_logo.jpg" alt="${member.apt_code}_logo" height="50">
    ...
    <div id="content">
        <img id="apt_img" src= "resources/img/${member.apt_code}.jpg" height="370" width="600">
        <table id="my_box">
            <tr>
                <td colspan="2">
                    <img src= "resources/img/${member.member_name}.jpg" alt="${member.member_name}" height="250" >
                </td>
            </tr>
            <tr>
                <td colspan="2" >
                    <p style="font-size: 17px;">
                    반갑습니다.${member.member_name}님<br>
