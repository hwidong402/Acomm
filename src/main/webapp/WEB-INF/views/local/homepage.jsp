...
<li class="nav-item"><a href="introduce.jsp">아파트 소개</a></li>
		...
		<div id="content">
			...
			<table id="my_box">
				...
				<tr>
					<td><a href="local/myinfo"><button
								class="btn btn-outline-primary" style="width: 200px;">내
								정보</button></a> <a href="m_logout"><button class="btn btn-outline-danger"
								style="width: 200px;">로그아웃</button></a></td>
				</tr>
				<tr>
					<td colspan="2">
					
					<c:if test="${member.member_cls==1}">
    					<a href="maneger/everyinfo"><button class="btn btn-outline-primary">회원관리</button></a>
					</c:if>
					</td>
				</tr>
