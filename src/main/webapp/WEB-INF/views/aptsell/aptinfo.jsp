...
<link href="resources/css/apt_struc.css" rel="stylesheet">
...
<body>
		...
		<div id="apistart">
			...
			<div id="api" style="height: 600px; overflow: auto;">
				...
				<div id="jan">
					<!-- 1월 부동산 자료 -->
					<!-- <hr color="green"> -->
					1월 ${city.apt_city} ${city.apt_town} ${city.apt_village} 아파트 실거래가 <a
						href=#none id="show1"
						onclick="if(d1.style.display=='none') {d1.style.display='';show1.innerText='접기'} 
							else {d1.style.display='none';show1.innerText='자세히'}">자세히</a>
					<br>
					<hr color="green">
					<%
						//결과를 저장할 result 변수 선언
					...
					try {
						...
						String url = "http://openapi.molit.go.kr/OpenAPI_ToolInstallPackage/service/rest/RTMSOBJSvc/getRTMSDataSvcAptTradeDev?serviceKey="
						+ key + "&pageNo=1&numOfRows=100&LAWD_CD=" + gu + "&DEAL_YMD=202301";
					...
					<div id="d1" style="display: none">
						...
						<table class="table table-hover">
							<tr>
								...
								<th width="180px" height="15px" style="text-align: left; white-space: nowrap;">실거래가(만원)</th>
				...
				<div id="dec">
					...
					<a href=#none id="show12"
						onclick="if(d12.style.display=='none') {d12.style.display='';show12.innerText='접기'} 
							else {d12.style.display='none';show12.innerText='자세히'}">자세히</a><br>
					<hr color="green">
					<%
						try {
						// parsing할 url 지정(API 키 포함해서)
						String url = "http://openapi.molit.go.kr/OpenAPI_ToolInstallPackage/service/rest/RTMSOBJSvc/getRTMSDataSvcAptTradeDev?serviceKey="
						+ key + "&pageNo=1&numOfRows=100&LAWD_CD=" + gu + "&DEAL_YMD=202212";
						DocumentBuilderFactory dbFactoty = DocumentBuilderFactory.newInstance();
						DocumentBuilder dBuilder = dbFactoty.newDocumentBuilder();
						org.w3c.dom.Document doc = dBuilder.parse(url);
						// 제일 첫번째 태그
				...
				<div id="nov">
					...
					<a href=#none id="show11"
						onclick="if(d11.style.display=='none') {d11.style.display='';show11.innerText='접기'} 
							else {d11.style.display='none';show11.innerText='자세히'}">자세히</a><br>
					<hr color="green">
					<%
						try {
						// parsing할 url 지정(API 키 포함해서)
						String url = "http://openapi.molit.go.kr/OpenAPI_ToolInstallPackage/service/rest/RTMSOBJSvc/getRTMSDataSvcAptTradeDev?serviceKey="
						+ key1 + "&pageNo=1&numOfRows=100&LAWD_CD=" + gu + "&DEAL_YMD=202211";
						DocumentBuilderFactory dbFactoty = DocumentBuilderFactory.newInstance();
						DocumentBuilder dBuilder = dbFactoty.newDocumentBuilder();
						org.w3c.dom.Document doc = dBuilder.parse(url);
						// 제일 첫번째 태그
				...
				<div id="oct">
					...
					<a href=#none id="show10"
						onclick="if(d10.style.display=='none') {d10.style.display='';show10.innerText='접기'} 
							else {d10.style.display='none';show10.innerText='자세히'}">자세히</a><br>
					<hr color="green">
					<%
						try {
						// parsing할 url 지정(API 키 포함해서)
						String url = "http://openapi.molit.go.kr/OpenAPI_ToolInstallPackage/service/rest/RTMSOBJSvc/getRTMSDataSvcAptTradeDev?serviceKey="
						+ key1 + "&pageNo=1&numOfRows=100&LAWD_CD=" + gu + "&DEAL_YMD=202210";
						DocumentBuilderFactory dbFactoty = DocumentBuilderFactory.newInstance();
						DocumentBuilder dBuilder = dbFactoty.newDocumentBuilder();
						org.w3c.dom.Document doc = dBuilder.parse(url);
						// 제일 첫번째 태그
	...
	else {result1.style.display='none';news1.innerText='자세히'}">자세히</a></h2></th>
</tr> -->
					<tr>
	...
	else {result2.style.display='none';news2.innerText='자세히'}">자세히</a></h2></th>
</tr> -->
					<tr>
	...
	else {result3.style.display='none';news3.innerText='자세히'}">자세히</a></h2></th>
</tr> -->
					<tr>
	...
	else {result4.style.display='none';news4.innerText='자세히'}">자세히</a></h2></th>
</tr> -->
					<tr>
	...
	else {result5.style.display='none';news5.innerText='자세히'}">자세히</a></h2></th>
</tr> -->
					<tr>
